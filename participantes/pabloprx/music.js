...
export const LEVELS = {
  ...
  "breathe": {
    ...
    // EL GUION, generado procedimentalmente (no dictado bailando): ver gen-breathe-script.js.
    // Sigue la estructura musical: un camino de un carril que se mueve de a uno por fila,
    // paredes de cajas ahuecadas por dentro (patron B + huecos + B, zanja minima de 3) y
    // low/high espaciados en el camino. El break (f56-f63, el apagon `dark`) va vacio.
    // Medido con el solver por filas de test-music.js a v=1400 y 4 carriles: pasable con
    // g=1 y con g=-1, sin bajar de 7 estados vivos en ninguna fila.
    // 510 directivas: 237 block, 221 gap, 24 low, 25 high, 3 jump orb.
script: [
      { row: 0, lane: 0, kind: "block" },
      { row: 0, lane: 1, kind: "low" },
      { row: 1, lane: 0, kind: "block" },
      { row: 2, lane: 0, kind: "block" },
      { row: 4, lane: 0, kind: "block" },
      { row: 5, lane: 0, kind: "block" },
      { row: 6, lane: 0, kind: "block" },
      { row: 8, lane: 0, kind: "block" },
      { row: 8, lane: 1, kind: "high" },
      { row: 9, lane: 0, kind: "block" },
      { row: 10, lane: 0, kind: "block" },
      { row: 12, lane: 0, kind: "block" },
      { row: 13, lane: 0, kind: "block" },
      { row: 14, lane: 0, kind: "block" },
      { row: 16, lane: 0, kind: "block" },
      { row: 16, lane: 2, kind: "low" },
      { row: 17, lane: 0, kind: "block" },
      { row: 18, lane: 0, kind: "block" },
      { row: 20, lane: 0, kind: "block" },
      { row: 21, lane: 0, kind: "block" },
      { row: 22, lane: 0, kind: "block" },
      { row: 24, lane: 0, kind: "block" },
      { row: 24, lane: 2, kind: "high" },
      { row: 25, lane: 0, kind: "block" },
      { row: 26, lane: 0, kind: "block" },
      { row: 28, lane: 0, kind: "block" },
      { row: 29, lane: 0, kind: "block" },
      { row: 30, lane: 0, kind: "block" },
      { row: 32, lane: 0, kind: "block" },
      { row: 32, lane: 2, kind: "block" },
      { row: 33, lane: 0, kind: "block" },
      { row: 33, lane: 2, kind: "block" },
      { row: 34, lane: 0, kind: "block" },
      { row: 34, lane: 2, kind: "block" },
      { row: 35, lane: 0, kind: "block" },
      { row: 36, lane: 0, kind: "low" },
      { row: 36, lane: 1, kind: "block" },
      { row: 36, lane: 2, kind: "block" },
      { row: 37, lane: 1, kind: "gap" },
      { row: 37, lane: 2, kind: "block" },
      { row: 38, lane: 1, kind: "gap" },
      { row: 38, lane: 2, kind: "block" },
      { row: 39, lane: 1, kind: "gap" },
      { row: 40, lane: 1, kind: "gap" },
      { row: 40, lane: 2, kind: "block" },
      { row: 41, lane: 1, kind: "gap" },
      { row: 41, lane: 2, kind: "block" },
      { row: 42, lane: 0, kind: "high" },
      { row: 42, lane: 1, kind: "gap" },
      { row: 42, lane: 2, kind: "block" },
      { row: 43, lane: 1, kind: "gap" },
      { row: 44, lane: 1, kind: "gap" },
      { row: 44, lane: 2, kind: "block" },
      { row: 45, lane: 1, kind: "gap" },
      { row: 45, lane: 2, kind: "block" },
      { row: 46, lane: 1, kind: "gap" },
      { row: 46, lane: 2, kind: "block" },
      { row: 47, lane: 1, kind: "block" },
      { row: 48, lane: 0, kind: "block" },
      { row: 48, lane: 1, kind: "low" },
      { row: 48, lane: 2, kind: "block" },
      { row: 49, lane: 0, kind: "gap" },
      { row: 49, lane: 2, kind: "block" },
      { row: 50, lane: 0, kind: "gap" },
      { row: 50, lane: 2, kind: "block" },
      { row: 51, lane: 0, kind: "gap" },
      { row: 52, lane: 0, kind: "gap" },
      { row: 52, lane: 1, kind: "block" },
      { row: 53, lane: 0, kind: "gap" },
      ...
      { row: 54, lane: 0, kind: "gap" },
      { row: 54, lane: 1, kind: "block" },
      { row: 54, lane: 2, kind: "high" },
      { row: 55, lane: 0, kind: "block" },
      { row: 64, lane: 0, kind: "block" },
      { row: 64, lane: 1, kind: "low" },
      { row: 64, lane: 2, kind: "block" },
      { row: 64, lane: 3, kind: "block" },
      { row: 65, lane: 0, kind: "gap" },
      { row: 65, lane: 1, role: "orb", kind: "orbj" },
      { row: 65, lane: 2, kind: "gap" },
      { row: 65, lane: 3, kind: "block" },
      { row: 66, lane: 0, kind: "gap" },
      { row: 66, lane: 2, kind: "gap" },
      { row: 66, lane: 3, kind: "block" },
      { row: 67, lane: 0, kind: "gap" },
      { row: 67, lane: 2, kind: "gap" },
      { row: 68, lane: 0, kind: "gap" },
      { row: 68, lane: 1, kind: "high" },
      { row: 68, lane: 2, kind: "gap" },
      { row: 68, lane: 3, kind: "block" },
      { row: 69, lane: 0, kind: "gap" },
      { row: 69, lane: 2, kind: "gap" },
      { row: 69, lane: 3, kind: "block" },
      { row: 70, lane: 0, kind: "gap" },
      { row: 70, lane: 2, kind: "gap" },
      { row: 70, lane: 3, kind: "block" },
      { row: 71, lane: 0, kind: "gap" },
      { row: 71, lane: 2, kind: "gap" },
      { row: 72, lane: 0, kind: "gap" },
      { row: 72, lane: 1, kind: "low" },
      { row: 72, lane: 2, kind: "gap" },
      { row: 72, lane: 3, kind: "block" },
      { row: 73, lane: 0, kind: "gap" },
      { row: 73, lane: 1, role: "orb", kind: "orbj" },
      { row: 73, lane: 2, kind: "gap" },
      { row: 73, lane: 3, kind: "block" },
      { row: 74, lane: 0, kind: "gap" },
      { row: 74, lane: 2, kind: "gap" },
      { row: 74, lane: 3, kind: "block" },
      { row: 75, lane: 0, kind: "gap" },
      { row: 75, lane: 2, kind: "gap" },
      { row: 76, lane: 0, kind: "gap" },
      { row: 76, lane: 1, kind: "high" },
      { row: 76, lane: 2, kind: "gap" },
      { row: 76, lane: 3, kind: "block" },
      { row: 77, lane: 0, kind: "gap" },
      { row: 77, lane: 2, kind: "gap" },
      { row: 77, lane: 3, kind: "block" },
      { row: 78, lane: 0, kind: "gap" },
      { row: 78, lane: 2, kind: "gap" },
      { row: 78, lane: 3, kind: "block" },
      { row: 79, lane: 0, kind: "gap" },
      { row: 79, lane: 2, kind: "block" },
      { row: 80, lane: 0, kind: "gap" },
      { row: 80, lane: 1, kind: "block" },
      { row: 80, lane: 2, kind: "low" },
      { row: 80, lane: 3, kind: "block" },
      { row: 81, lane: 0, kind: "gap" },
      { row: 81, lane: 1, kind: "gap" },
      { row: 81, lane: 2, role: "orb", kind: "orbj" },
      { row: 81, lane: 3, kind: "block" },
      { row: 82, lane: 0, kind: "gap" },
      { row: 82, lane: 1, kind: "gap" },
      { row: 82, lane: 3, kind: "block" },
      { row: 83, lane: 0, kind: "gap" },
      { row: 83, lane: 1, kind: "gap" },
      { row: 84, lane: 0, kind: "gap" },
      { row: 84, lane: 1, kind: "gap" },
      { row: 84, lane: 2, kind: "high" },
      { row: 84, lane: 3, kind: "block" },
      { row: 85, lane: 0, kind: "gap" },
      { row: 85, lane: 1, kind: "gap" },
      { row: 85, lane: 3, kind: "block" },
      { row: 86, lane: 0, kind: "gap" },
      { row: 86, lane: 1, kind: "gap" },
      { row: 86, lane: 3, kind: "block" },
      { row: 87, lane: 0, kind: "gap" },
      { row: 87, lane: 1, kind: "gap" },
      { row: 88, lane: 0, kind: "gap" },
      { row: 88, lane: 1, kind: "gap" },
      { row: 88, lane: 2, kind: "low" },
      { row: 88, lane: 3, kind: "block" },
      { row: 89, lane: 0, kind: "gap" },
      { row: 89, lane: 1, kind: "gap" },
      { row: 89, lane: 3, kind: "block" },
      { row: 90, lane: 0, kind: "gap" },
      { row: 90, lane: 1, kind: "gap" },
      { row: 90, lane: 3, kind: "block" },
      { row: 91, lane: 0, kind: "gap" },
      { row: 91, lane: 1, kind: "gap" },
      { row: 92, lane: 0, kind: "gap" },
      { row: 92, lane: 1, kind: "gap" },
      { row: 92, lane: 2, kind: "high" },
      { row: 92, lane: 3, kind: "block" },
      { row: 93, lane: 0, kind: "gap" },
      { row: 93, lane: 1, kind: "gap" },
      { row: 93, lane: 3, kind: "block" },
      { row: 94, lane: 0, kind: "gap" },
      { row: 94, lane: 1, kind: "gap" },
      { row: 94, lane: 3, kind: "block" },
      { row: 95, lane: 0, kind: "gap" },
      { row: 95, lane: 1, kind: "block" },
      { row: 96, lane: 0, kind: "gap" },
      { row: 96, lane: 1, kind: "low" },
      ...
      { row: 96, lane: 3, kind: "block" },
      { row: 97, lane: 0, kind: "gap" },
      { row: 97, lane: 2, kind: "gap" },
      { row: 97, lane: 3, kind: "block" },
      { row: 98, lane: 0, kind: "gap" },
      { row: 98, lane: 2, kind: "gap" },
      { row: 98, lane: 3, kind: "block" },
      { row: 99, lane: 0, kind: "block" },
      { row: 99, lane: 2, kind: "gap" },
      { row: 100, lane: 0, kind: "high" },
      { row: 100, lane: 1, kind: "block" },
      { row: 100, lane: 2, kind: "gap" },
      { row: 100, lane: 3, kind: "block" },
      { row: 101, lane: 1, kind: "gap" },
      { row: 101, lane: 2, kind: "gap" },
      { row: 101, lane: 3, kind: "block" },
      { row: 102, lane: 1, kind: "gap" },
      { row: 102, lane: 2, kind: "gap" },
      { row: 102, lane: 3, kind: "block" },
      { row: 103, lane: 1, kind: "gap" },
      { row: 103, lane: 2, kind: "gap" },
      { row: 104, lane: 0, kind: "low" },
      { row: 104, lane: 1, kind: "gap" },
      { row: 104, lane: 2, kind: "gap" },
      { row: 104, lane: 3, kind: "block" },
      { row: 105, lane: 1, kind: "gap" },
      { row: 105, lane: 2, kind: "gap" },
      { row: 105, lane: 3, kind: "block" },
      { row: 106, lane: 1, kind: "gap" },
      { row: 106, lane: 2, kind: "gap" },
      { row: 106, lane: 3, kind: "block" },
      { row: 107, lane: 1, kind: "gap" },
      { row: 107, lane: 2, kind: "gap" },
      { row: 108, lane: 0, kind: "high" },
      { row: 108, lane: 1, kind: "gap" },
      { row: 108, lane: 2, kind: "gap" },
      { row: 108, lane: 3, kind: "block" },
      { row: 109, lane: 1, kind: "gap" },
      { row: 109, lane: 2, kind: "gap" },
      { row: 109, lane: 3, kind: "block" },
      { row: 110, lane: 1, kind: "gap" },
      { row: 110, lane: 2, kind: "gap" },
      { row: 110, lane: 3, kind: "block" },
      { row: 111, lane: 1, kind: "block" },
      { row: 111, lane: 2, kind: "gap" },
      { row: 112, lane: 0, kind: "block" },
      { row: 112, lane: 1, kind: "low" },
      { row: 112, lane: 2, kind: "gap" },
      { row: 112, lane: 3, kind: "block" },
      { row: 113, lane: 0, kind: "gap" },
      { row: 113, lane: 2, kind: "gap" },
      { row: 113, lane: 3, kind: "block" },
      { row: 114, lane: 0, kind: "gap" },
      { row: 114, lane: 2, kind: "gap" },
      { row: 114, lane: 3, kind: "block" },
      { row: 115, lane: 0, kind: "gap" },
      { row: 115, lane: 2, kind: "block" },
      { row: 116, lane: 0, kind: "gap" },
      { row: 116, lane: 1, kind: "block" },
      { row: 116, lane: 2, kind: "high" },
      { row: 116, lane: 3, kind: "block" },
      { row: 117, lane: 0, kind: "gap" },
      { row: 117, lane: 1, kind: "gap" },
      { row: 117, lane: 3, kind: "block" },
      { row: 118, lane: 0, kind: "gap" },
      { row: 118, lane: 1, kind: "gap" },
      { row: 118, lane: 3, kind: "block" },
      { row: 119, lane: 0, kind: "gap" },
      { row: 119, lane: 1, kind: "gap" },
      { row: 120, lane: 0, kind: "gap" },
      { row: 120, lane: 1, kind: "gap" },
      { row: 120, lane: 2, kind: "block" },
      { row: 120, lane: 3, kind: "low" },
      { row: 121, lane: 0, kind: "gap" },
      { row: 121, lane: 1, kind: "gap" },
      { row: 121, lane: 2, kind: "block" },
      { row: 122, lane: 0, kind: "gap" },
      { row: 122, lane: 1, kind: "gap" },
      { row: 122, lane: 2, kind: "block" },
      { row: 123, lane: 0, kind: "gap" },
      { row: 123, lane: 1, kind: "gap" },
      { row: 124, lane: 0, kind: "gap" },
      { row: 124, lane: 1, kind: "gap" },
      { row: 124, lane: 2, kind: "block" },
      { row: 124, lane: 3, kind: "high" },
      { row: 125, lane: 0, kind: "gap" },
      { row: 125, lane: 1, kind: "gap" },
      { row: 125, lane: 2, kind: "block" },
      { row: 126, lane: 0, kind: "gap" },
      { row: 126, lane: 1, kind: "gap" },
      { row: 126, lane: 2, kind: "block" },
      { row: 127, lane: 0, kind: "gap" },
      { row: 127, lane: 1, kind: "gap" },
      { row: 128, lane: 0, kind: "gap" },
      { row: 128, lane: 1, kind: "gap" },
      { row: 128, lane: 2, kind: "low" },
      { row: 128, lane: 3, kind: "block" },
      { row: 129, lane: 0, kind: "gap" },
      { row: 129, lane: 1, kind: "gap" },
      { row: 129, lane: 3, kind: "block" },
      { row: 130, lane: 0, kind: "gap" },
      { row: 130, lane: 1, kind: "gap" },
      { row: 130, lane: 3, kind: "block" },
      { row: 131, lane: 0, kind: "gap" },
      { row: 131, lane: 1, kind: "block" },
      { row: 132, lane: 0, kind: "gap" },
      { row: 132, lane: 1, kind: "high" },
      { row: 132, lane: 2, kind: "block" },
      { row: 132, lane: 3, kind: "block" },
      { row: 133, lane: 0, kind: "gap" },
      { row: 133, lane: 2, kind: "gap" },
      { row: 133, lane: 3, kind: "block" },
      { row: 134, lane: 0, kind: "gap" },
      { row: 134, lane: 2, kind: "gap" },
      { row: 134, lane: 3, kind: "block" },
      { row: 135, lane: 0, kind: "gap" },
      { row: 135, lane: 2, kind: "gap" },
      { row: 136, lane: 0, kind: "gap" },
      { row: 136, lane: 1, kind: "low" },
      { row: 136, lane: 2, kind: "gap" },
      { row: 136, lane: 3, kind: "block" },
      { row: 137, lane: 0, kind: "gap" },
      { row: 137, lane: 2, kind: "gap" },
      { row: 137, lane: 3, kind: "block" },
      { row: 138, lane: 0, kind: "gap" },
      { row: 138, lane: 2, kind: "gap" },
      { row: 138, lane: 3, kind: "block" },
      { row: 139, lane: 0, kind: "gap" },
      { row: 139, lane: 2, kind: "gap" },
      { row: 140, lane: 0, kind: "gap" },
      { row: 140, lane: 1, kind: "high" },
      { row: 140, lane: 2, kind: "gap" },
      { row: 140, lane: 3, kind: "block" },
      { row: 141, lane: 0, kind: "gap" },
      { row: 141, lane: 2, kind: "gap" },
      { row: 141, lane: 3, kind: "block" },
      { row: 142, lane: 0, kind: "gap" },
      { row: 142, lane: 2, kind: "gap" },
      { row: 142, lane: 3, kind: "block" },
      { row: 143, lane: 0, kind: "gap" },
      { row: 143, lane: 2, kind: "block" },
      { row: 144, lane: 0, kind: "gap" },
      { row: 144, lane: 1, kind: "block" },
      { row: 144, lane: 2, kind: "low" },
      { row: 144, lane: 3, kind: "block" },
      { row: 145, lane: 0, kind: "gap" },
      { row: 145, lane: 1, kind: "gap" },
      { row: 145, lane: 3, kind: "block" },
      { row: 146, lane: 0, kind: "gap" },
      { row: 146, lane: 1, kind: "gap" },
      { row: 146, lane: 3, kind: "block" },
      { row: 147, lane: 0, kind: "gap" },
      { row: 147, lane: 1, kind: "gap" },
      { row: 148, lane: 0, kind: "gap" },
      { row: 148, lane: 1, kind: "gap" },
      { row: 148, lane: 2, kind: "high" },
      { row: 148, lane: 3, kind: "block" },
      { row: 149, lane: 0, kind: "gap" },
      { row: 149, lane: 1, kind: "gap" },
      { row: 149, lane: 3, kind: "block" },
      { row: 150, lane: 0, kind: "gap" },
      { row: 150, lane: 1, kind: "gap" },
      { row: 150, lane: 3, kind: "block" },
      { row: 151, lane: 0, kind: "gap" },
      { row: 151, lane: 1, kind: "gap" },
      { row: 152, lane: 0, kind: "gap" },
      { row: 152, lane: 1, kind: "gap" },
      { row: 152, lane: 2, kind: "low" },
      { row: 152, lane: 3, kind: "block" },
      { row: 153, lane: 0, kind: "gap" },
      { row: 153, lane: 1, kind: "gap" },
      { row: 153, lane: 3, kind: "block" },
      { row: 154, lane: 0, kind: "gap" },
      { row: 154, lane: 1, kind: "gap" },
      { row: 154, lane: 3, kind: "block" },
      { row: 155, lane: 0, kind: "gap" },
      { row: 155, lane: 1, kind: "gap" },
      { row: 156, lane: 0, kind: "gap" },
      { row: 156, lane: 1, kind: "gap" },
      { row: 156, lane: 2, kind: "high" },
      { row: 156, lane: 3, kind: "block" },
      { row: 157, lane: 0, kind: "gap" },
      { row: 157, lane: 1, kind: "gap" },
      { row: 157, lane: 3, kind: "block" },
      { row: 158, lane: 0, kind: "gap" },
      { row: 158, lane: 1, kind: "gap" },
      { row: 158, lane: 3, kind: "block" },
      { row: 159, lane: 0, kind: "gap" },
      { row: 159, lane: 1, kind: "block" },
      { row: 160, lane: 0, kind: "gap" },
      { row: 160, lane: 2, kind: "block" },
      { row: 161, lane: 0, kind: "gap" },
      { row: 161, lane: 2, kind: "block" },
      { row: 162, lane: 0, kind: "gap" },
      { row: 162, lane: 1, kind: "high" },
      { row: 162, lane: 2, kind: "block" },
      { row: 163, lane: 0, kind: "block" },
      { row: 164, lane: 1, kind: "block" },
      { row: 164, lane: 2, kind: "block" },
      { row: 165, lane: 1, kind: "gap" },
      { row: 165, lane: 2, kind: "block" },
      { row: 166, lane: 1, kind: "gap" },
      { row: 166, lane: 2, kind: "block" },
      { row: 167, lane: 1, kind: "gap" },
      { row: 168, lane: 0, kind: "low" },
      { row: 168, lane: 1, kind: "gap" },
      { row: 168, lane: 2, kind: "block" },
      { row: 169, lane: 1, kind: "gap" },
      { row: 169, lane: 2, kind: "block" },
      { row: 170, lane: 1, kind: "gap" },
      { row: 170, lane: 2, kind: "block" },
      { row: 171, lane: 1, kind: "gap" },
      { row: 172, lane: 1, kind: "gap" },
      { row: 172, lane: 2, kind: "block" },
      { row: 173, lane: 1, kind: "gap" },
      { row: 173, lane: 2, kind: "block" },
      { row: 174, lane: 0, kind: "high" },
      { row: 174, lane: 1, kind: "gap" },
      { row: 174, lane: 2, kind: "block" },
      { row: 175, lane: 1, kind: "block" },
      { row: 176, lane: 0, kind: "block" },
      { row: 176, lane: 2, kind: "block" },
      { row: 177, lane: 0, kind: "gap" },
      { row: 177, lane: 2, kind: "block" },
      { row: 178, lane: 0, kind: "gap" },
      { row: 178, lane: 2, kind: "block" },
      { row: 179, lane: 0, kind: "gap" },
      { row: 180, lane: 0, kind: "gap" },
      { row: 180, lane: 1, kind: "block" },
      { row: 180, lane: 2, kind: "low" },
      { row: 181, lane: 0, kind: "gap" },
      { row: 181, lane: 1, kind: "block" },
      { row: 182, lane: 0, kind: "gap" },
      { row: 182, lane: 1, kind: "block" },
      { row: 183, lane: 0, kind: "gap" },
      { row: 184, lane: 0, kind: "gap" },
      { row: 184, lane: 1, kind: "block" },
      { row: 185, lane: 0, kind: "gap" },
      { row: 185, lane: 1, kind: "block" },
      { row: 186, lane: 0, kind: "gap" },
      { row: 186, lane: 1, kind: "block" },
      { row: 186, lane: 3, kind: "high" },
      { row: 187, lane: 0, kind: "gap" },
      { row: 188, lane: 0, kind: "gap" },
      { row: 188, lane: 1, kind: "block" },
      { row: 189, lane: 0, kind: "gap" },
      { row: 189, lane: 1, kind: "block" },
      { row: 190, lane: 0, kind: "gap" },
      { row: 190, lane: 1, kind: "block" },
      { row: 191, lane: 0, kind: "gap" },
      { row: 192, lane: 0, kind: "gap" },
      { row: 192, lane: 2, kind: "low" },
      { row: 193, lane: 0, kind: "gap" },
      { row: 194, lane: 0, kind: "block" },
      { row: 196, lane: 0, kind: "block" },
      { row: 197, lane: 0, kind: "block" },
      { row: 198, lane: 0, kind: "block" },
      { row: 200, lane: 0, kind: "block" },
      { row: 200, lane: 1, kind: "high" },
      { row: 201, lane: 0, kind: "block" },
      { row: 202, lane: 0, kind: "block" },
      { row: 204, lane: 0, kind: "block" },
      { row: 205, lane: 0, kind: "block" },
      { row: 206, lane: 0, kind: "block" },
      { row: 208, lane: 0, kind: "block" },
      { row: 208, lane: 2, kind: "low" },
      { row: 209, lane: 0, kind: "block" },
      { row: 210, lane: 0, kind: "block" },
      { row: 212, lane: 0, kind: "block" },
      { row: 213, lane: 0, kind: "block" },
      { row: 214, lane: 0, kind: "block" },
      { row: 216, lane: 0, kind: "block" },
      { row: 216, lane: 2, kind: "high" },
      { row: 217, lane: 0, kind: "block" },
      { row: 218, lane: 0, kind: "block" },
      { row: 220, lane: 0, kind: "block" },
      { row: 221, lane: 0, kind: "block" },
      { row: 222, lane: 0, kind: "block" },
      { row: 224, lane: 0, kind: "block" },
      { row: 224, lane: 1, kind: "low" },
      { row: 225, lane: 0, kind: "block" },
      { row: 226, lane: 0, kind: "block" },
      { row: 228, lane: 1, kind: "block" },
      { row: 229, lane: 1, kind: "block" },
      { row: 230, lane: 1, kind: "block" },
      { row: 232, lane: 0, kind: "high" },
      { row: 232, lane: 1, kind: "block" },
      { row: 233, lane: 1, kind: "block" },
      { row: 234, lane: 1, kind: "block" },
      { row: 236, lane: 1, kind: "block" },
      { row: 237, lane: 1, kind: "block" },
      { row: 238, lane: 1, kind: "block" },
      { row: 240, lane: 0, kind: "block" },
      { row: 240, lane: 1, kind: "low" },
      { row: 241, lane: 0, kind: "block" },
      { row: 242, lane: 0, kind: "block" },
      { row: 244, lane: 0, kind: "block" },
      { row: 245, lane: 0, kind: "block" },
      { row: 246, lane: 0, kind: "block" },
      { row: 248, lane: 0, kind: "block" },
      { row: 248, lane: 3, kind: "high" },
      { row: 249, lane: 0, kind: "block" },
      { row: 250, lane: 0, kind: "block" },
      { row: 252, lane: 0, kind: "block" },
      { row: 253, lane: 0, kind: "block" },
      { row: 254, lane: 0, kind: "block" },
      { row: 256, lane: 0, kind: "block" },
      { row: 256, lane: 2, kind: "low" },
      { row: 257, lane: 0, kind: "block" },
      { row: 258, lane: 0, kind: "block" },
      { row: 260, lane: 0, kind: "block" },
      { row: 261, lane: 0, kind: "block" },
      { row: 262, lane: 0, kind: "block" },
      { row: 264, lane: 0, kind: "block" },
      { row: 264, lane: 1, kind: "high" },
      { row: 265, lane: 0, kind: "block" },
      { row: 266, lane: 0, kind: "block" },
      { row: 268, lane: 0, kind: "block" },
      { row: 269, lane: 0, kind: "block" },
      { row: 270, lane: 0, kind: "block" },
      { row: 272, lane: 0, kind: "block" },
      { row: 272, lane: 2, kind: "low" },
      { row: 273, lane: 0, kind: "block" },
      { row: 274, lane: 0, kind: "block" },
      { row: 276, lane: 0, kind: "block" },
      { row: 277, lane: 0, kind: "block" },
      { row: 278, lane: 0, kind: "block" },
      { row: 280, lane: 0, kind: "block" },
      { row: 280, lane: 2, kind: "high" },
      { row: 281, lane: 0, kind: "block" },
      { row: 282, lane: 0, kind: "block" },
      { row: 284, lane: 0, kind: "block" },
      { row: 285, lane: 0, kind: "block" },
      { row: 286, lane: 0, kind: "block" },
],
  },
};
